    ...
    <>
      ...
      <Grid container spacing={2} size={12}>
        <Grid size={{ xs: 12, sm: 12, md: 9, lg: 9 }}>
          <Paper style={{ marginTop: 20 }} sx={{ bgcolor: "background.card" }}>
      ...
      <Grid container spacing={2} size={12}>
        <Grid size={{ xs: 12, sm: 12, md: 9, lg: 9 }}>
          <Paper sx={{ bgcolor: "background.card" }} style={{ marginTop: 20, padding: 20 }}>
        ...
        <Grid size={{ xs: 12, sm: 12, md: 3, lg: 3 }}>
          <Paper sx={{ bgcolor: "background.card" }} style={{ marginTop: 20, padding: 10, display: 'flex', flexDirection: 'column' }}>
